...
public class Calculator extends JPanel implements ActionListener {
    ...
    private int _buttonWidth = 44;
    private int _buttonHeight = 44;
...
//        System.out.println("10 * 24 = " + calculator.getDisplayText());
        ...
        cp.add(calculator, BorderLayout.CENTER);

        final JFrame frame = new JFrame(Calculator.class.getSimpleName());
